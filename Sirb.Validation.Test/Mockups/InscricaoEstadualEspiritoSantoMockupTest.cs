...
{
    [Fact(DisplayName = "InscricaoEstadual.Generate should produce a valid Espírito Santo IE")]
    ...
    [Fact(DisplayName = "InscricaoEstadual.Generate should produce valid Espírito Santo IE in 2000 iterations")]
