...
{
    [Fact(DisplayName = "InscricaoEstadual.Generate should produce a valid Rio de Janeiro IE")]
    ...
    [Fact(DisplayName = "InscricaoEstadual.Generate should produce valid Rio de Janeiro IE in 2000 iterations")]
