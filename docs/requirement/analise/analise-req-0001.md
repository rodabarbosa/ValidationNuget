...
resource: "./requirement/analise/analise-req-0001.md"
...
# Análise Cross-Artifact — req-0001 (CPF — Validação)
...
- **Versão dos artefatos analisados:** req-0001 v1.1.0, tec-req-0001 v1.1.0
- **Versão deste documento:** 1.1.0
- **Status:** Aprovado

## Escopo da análise

- `req-0001-cpf-validacao.md` (v1.1.0)
- `tec-req-0001-cpf-validacao.md` (v1.1.0)
- `apf/apf-req-0001.md` (v1.1.0)
- `system-risk-matrix.md` (v1.1.0)
...
| - | ----------- | --------- | --------- | --------- | -------------- |
| 1 | Mesmo `XXXX` e mesma versão em req-XXXX e tec-req-XXXX | req ↔ tec | OK | Ambos usam `0001` e versão `1.1.0` | — |
...
| 3 | RFs e RNs consistentes entre docs (sem gaps) | req ↔ tec | OK | RF-001 a RF-004 e RN-001 a RN-004 idênticas | — |
...
| 7 | APF cobre funções; totais consistentes | apf ↔ tamanho | OK | apf-req-0001: 6 PF; será consolidado em tamanho-aplicacao.md | — |
| 8 | Risco local consistente com matriz global | req ↔ matriz | OK | RSK-001/003 com mesmos IDs, scores e níveis | — |
...
| Dados e Privacidade | Sim | DATA-01 (CPF é dado sensível), DATA-04 (mascaramento — aplicável via req-0014) | — |
...
| 31/07/2026 | Rodrigo Araujo Barbosa | 1.1.0 | Análise atualizada para o escopo de validação pura (remoção de máscara — req-0001/tec-req-0001 v1.1.0, APF 6 PF) |
