---
type: checklist
title: "checklist-req-0015 — CNPJ — Máscara (Quality Checklist)"
description: "Quality Checklist 8 dimensões para req-0015-cnpj-mascara"
resource: "./requirement/checklist/checklist-req-0015.md"
tags: [checklist, quality, mascara, cnpj]
generated:
  by: "Opencode — writer"
...
status: approved
domain:
  artifact_id: "checklist-req-0015"
  title_pt: "CNPJ — Máscara — Quality Checklist"
  version: "1.0.0"
...
# checklist-req-0015 — CNPJ — Máscara (Quality Checklist)

## Metadados

| Campo | Valor |
|---|---|
| **Requisito avaliado** | `req-0015-cnpj-mascara.md` v1.0.0 |
| **Veredito** | **APROVADO** |
...
| 3 | **Testabilidade** | **Pass** | 7 cenários Gherkin observáveis; testes unitários em `CnpjExtensionTest.cs` |
| 4 | **Rastreabilidade** | **Pass** | Rastreabilidade preenchida; APF, análise, risco, tec-req referenciados |
| 5 | **Conformidade Constituição** | **Pass** | SEC-06/07, PERF-01/02, QUAL-01, ARCH-03 atendidos |
| 6 | **Consistência Cross-Artifact** | **Pass** | `analise-req-0015` = APROVADO |
