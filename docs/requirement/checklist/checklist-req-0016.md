---
type: checklist
title: "checklist-req-0016 — PIS — Máscara (Quality Checklist)"
description: "Quality Checklist 8 dimensões para req-0016-pis-mascara"
resource: "./requirement/checklist/checklist-req-0016.md"
tags: [checklist, quality, mascara, pis]
generated:
  by: "Opencode — writer"
...
status: approved
domain:
  artifact_id: "checklist-req-0016"
  title_pt: "PIS — Máscara — Quality Checklist"
  version: "1.0.0"
...
# checklist-req-0016 — PIS — Máscara (Quality Checklist)

## Metadados

| Campo | Valor |
|---|---|
| **Requisito avaliado** | `req-0016-pis-mascara.md` v1.0.0 |
| **Veredito** | **APROVADO** |
...
| 3 | **Testabilidade** | **Pass** | 7 cenários Gherkin; testes em `PisExtensionTest.cs` |
...
| 6 | **Consistência Cross-Artifact** | **Pass** | `analise-req-0016` = APROVADO |
