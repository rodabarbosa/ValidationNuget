...
resource: "./requirement/analises/analise-req-0002.md"
...
- **Versão dos artefatos analisados:** req-0002 v1.0.0, tec-req-0002 v1.0.0
...
| - | ----------- | --------- |
| 1 | req ↔ tec: mesmo XXXX e versão | OK (0002, v1.0.0) |
